...
${COLORS.bold}What gets installed:${COLORS.reset}
  .opencode/    11 agents, 8 commands, 4 rules, 152 skills, 7 doc templates
...
function initProject(projectDir, options = {}) {
  ...
  const copyTasks = [
    { src: '.opencode', dest: '.opencode', desc: '11 agents, 8 commands, 4 rules, 152 skills, 8 doc templates, RTK hook' },
